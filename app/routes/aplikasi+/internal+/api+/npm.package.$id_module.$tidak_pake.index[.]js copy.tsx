...
export const loader = async ({ request, context, params }: LoaderFunctionArgs) => {
  ...
  try {
    const { data } = await axios({
      method: "GET",
      url: `${process.env.LOWCODER_PROTOCOL}//${process.env.LOWCODER_HOST}:${process.env.LOWCODER_PORT}/api/npm/package/${id_module}/lowcoder-comps@latest/index.js`,
     // headers: {
