...
export const loader = async ({ request, context, params }: LoaderFunctionArgs) => {
    ...
    try {
        const { data } = await axios({
            method: "GET",
            url: `${process.env.LOWCODER_PROTOCOL}//${process.env.LOWCODER_HOST}:${process.env.LOWCODER_PORT}/api/datasources/jsDatasourcePlugins?appId=6801f92e16b756579000e667`,
            headers:{
