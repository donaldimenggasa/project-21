...
import RelatedImage03 from '~/assets/images/career-01.jpg'
import RelatedImage04 from '~/assets/images/career-04.jpg'
import RelatedImage05 from '~/assets/images/hero-bg-03.jpg'
import RelatedImage06 from '~/assets/images/related-post-06.jpg'
        ...
        <div className="pb-12 md:pb-16">
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4" data-aos-id-featposts>
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="100">
              <figure>
                <img className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-75 transition duration-700 ease-out rounded-sm" src={RelatedImage03} alt="Related post 03" />
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <Link className="" to="/aplikasi/internal">
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="200">
              <figure>
                <img className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-75 transition duration-700 ease-out rounded-sm" src={RelatedImage04} alt="Related post 04" />
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <Link className="" to="/aplikasi/external">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="300">
              <figure>
                <img className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-75 transition duration-700 ease-out rounded-sm" src={RelatedImage05} alt="Related post 05" />
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                <Link className="" to="/aplikasi/layanan">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="400">
              <figure>
                <img className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-75 transition duration-700 ease-out rounded-sm" src={RelatedImage06} alt="Related post 06" />
