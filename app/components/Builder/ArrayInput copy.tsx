...
const ArrayPropertyEditor = memo(({title, componentProps, value = [], onChange }: EditorProps) => {
  ...
  return (
    <div className="space-y-4">
      <div className=" flex items-center justify-between mb-2 px-2">
        ...
        <button className="bloc text-xs text-gray-300 cursor-pointer" >
...
ArrayPropertyEditor.displayName = 'TableColumnEditor';
export { ArrayPropertyEditor }
